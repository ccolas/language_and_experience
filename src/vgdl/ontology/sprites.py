...
from src.vgdl.core import VGDLSprite, Action, Resource, Immutable
from src.vgdl.core import Color
        ...
        if self._age == 2:
            for u in BASEDIRS:
                if game.random_generator.random() < self.spreadprob:
                    game.add_sprite_creation(self.name, (self.lastrect.left + u[0] * self.lastrect.size[0],
